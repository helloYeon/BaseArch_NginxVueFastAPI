"""tests/api/test_PP010_params.py"""
...
from enums import IsConfirmation
...
test_PP010 = [
    ...
    (
        ...
        None,
        None,
        {"invoiceId": 1, "isConfirmation": IsConfirmation.CONFIRMED},
        PutResponse(
...
test_PP010_exception = [
    ...
    (
        ...
        None,
        None,
        {"invoiceId": "test", "isConfirmation": IsConfirmation.CONFIRMED},
        ErrorModel(
            header=Header(
    ...
    # case 2 : I0001 isConfirmationパラメーターが存在しない数字
    (
        CompanyInfo(
            id=1, esCompanyId=1, name="unittestCompanyName1", parentEsCompanyId=1
        ),
        ...
        None,
        None,
        {"invoiceId": 1, "isConfirmation": 2},
        ErrorModel(
            header=Header(
                code=messages.INVALID_PARAMETER.code,
                message="isConfirmation is Input should be 0 or 1",
            ),
            payload=None,
        ).model_dump(mode="json"),
        status.HTTP_422_UNPROCESSABLE_ENTITY,
    ),
    # case 3 : I0001 isConfirmationパラメーターが文字列
    (
        CompanyInfo(
            id=1, esCompanyId=1, name="unittestCompanyName1", parentEsCompanyId=1
        ),
        ...
        None,
        None,
        {"invoiceId": 1, "isConfirmation": "test"},
        ErrorModel(
            header=Header(
                code=messages.INVALID_PARAMETER.code,
                message="isConfirmation is Input should be 0 or 1",
    ...
    # case 5 : I0001 isConfirmationパラメーターが存在しない
    (
        CompanyInfo(
            id=1, esCompanyId=1, name="unittestCompanyName1", parentEsCompanyId=1
        ),
        ...
        ErrorModel(
            header=Header(
                code=messages.INVALID_PARAMETER.code,
                message="isConfirmation is Field required",
            ),
            payload=None,
        ).model_dump(mode="json"),
        status.HTTP_422_UNPROCESSABLE_ENTITY,
    ...
    (
        ...
        {"invoiceId": 999, "isConfirmation": IsConfirmation.CONFIRMED},
        ErrorModel(
            header=Header(
