"""tests/api/test_PP011_params.py"""
...
test_PP011 = [
    ...
    (
        ...
        None,
        None,
        {"invoiceId": 1, "isOpen": IsOpen.OPENED},
        PutResponse(
...
test_PP011_exception = [
    ...
    (
        ...
        None,
        None,
        {"invoiceId": "test", "isOpen": IsOpen.OPENED},
        ErrorModel(
            header=Header(
    ...
    # case 2 : I0001 isOpenパラメーターが存在しない数字
    (
        CompanyInfo(
            id=1, esCompanyId=1, name="unittestCompanyName1", parentEsCompanyId=1
        ),
        ...
        None,
        None,
        {"invoiceId": 1, "isOpen": 2},
        ErrorModel(
            header=Header(
                code=messages.INVALID_PARAMETER.code,
                message="isOpen is Input should be 0 or 1",
            ),
            payload=None,
        ).model_dump(mode="json"),
        status.HTTP_422_UNPROCESSABLE_ENTITY,
    ),
    # case 3 : I0001 isOpenパラメーターが文字列
    (
        CompanyInfo(
            id=1, esCompanyId=1, name="unittestCompanyName1", parentEsCompanyId=1
        ),
    ...
    # case 5 : I0001 isOpenパラメーターが存在しない
    (
        CompanyInfo(
            id=1, esCompanyId=1, name="unittestCompanyName1", parentEsCompanyId=1
        ),
        ...
        ErrorModel(
            header=Header(
                code=messages.INVALID_PARAMETER.code,
                message="isOpen is Field required",
            ),
            payload=None,
        ).model_dump(mode="json"),
        status.HTTP_422_UNPROCESSABLE_ENTITY,
    ...
    (
        ...
        {"invoiceId": 999, "isOpen": IsOpen.OPENED},
        ErrorModel(
            header=Header(
